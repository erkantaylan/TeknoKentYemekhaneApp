...
namespace YemekhaneApp.Frontend.Services
{
    public class EmployeeService
    {
        ...
        public async Task<EmployeeUpdateViewModel> GetEmployeeByIdToUpdateAsync(Guid id)
        {
            return await _httpClient.GetFromJsonAsync<EmployeeUpdateViewModel>($"api/employee/{id}");
        }
